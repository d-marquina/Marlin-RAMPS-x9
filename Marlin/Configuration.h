...
#ifndef MOTHERBOARD
#define MOTHERBOARD BOARD_RAMPS_14_x9
#endif
...
#define U_DRIVER_TYPE DRV8825
#define V_DRIVER_TYPE DRV8825
#define W_DRIVER_TYPE DRV8825
...
#define U_MIN_ENDSTOP_INVERTING true        // Set to true to invert the logic of the endstop.
#define V_MIN_ENDSTOP_INVERTING true        // Set to true to invert the logic of the endstop.
#define W_MIN_ENDSTOP_INVERTING true        // Set to true to invert the logic of the endstop.
...
#define U_MAX_ENDSTOP_INVERTING true        // Set to true to invert the logic of the endstop.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT {800, 800, 800, 800, 800, 800, 800, 800, 800}
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE {10, 10, 10, 10, 10, 10, 10, 10, 10}
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION {5, 5, 5, 5, 5, 5, 5, 5, 5}
...
#define V_MIN_POS 0
#define V_MAX_POS 360
#define W_MIN_POS 0
#define W_MAX_POS 360
...
#define HOMING_FEEDRATE_MM_M {(2 * 60), (2 * 60), (2 * 60), (2 * 60), (2 * 60), (2 * 60), (2 * 60), (2 * 60), (2 * 60)}
